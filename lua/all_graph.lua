...
function set_settings()
	...
	graph_settings={
	      ...
	      arg="",
                ...
                nb_values=200,
                background =false,
                fg_colour={ {0,0x034d7b,1}, {1,0x055a9d,1}},
                fg_orientation="ww",
				foreground=false,
				fg_bd_size=1,
				fg_bd_colour = { {0,0x034d7b,1}, {1,0x055a9d,1}},
        },
				{--CPU avg Bar
				name="cpu",
				arg="cpu1",
				...
				foreground=false,
				fg_bd_size=1,
				fg_bd_colour = { {0,0x0F5E85,1}, {1,0x1793d0,1}},
				},
				{--CPU avg Bar
				name="cpu",
				arg="cpu2",
        ...
        nb_values=200,
        background =false,
        fg_colour={ {0,0x5E0Fe5,1}, {1,0x7317ff,1}},
        fg_orientation="ww",
				foreground=false,
				fg_bd_size=1,
				fg_bd_colour = { {0,0x5E0Fe5,1}, {1,0x7317ff,1}},
        },
				{--HDD io graph
	      name="exec",
        ...
        nb_values=200,
        background =false,
        fg_colour={ {0,0x0F855E,1}, {1,0x17d093,1}},
        fg_orientation="ww",
				foreground=false,
				fg_bd_size=1,
				fg_bd_colour = { {0,0x0F855E,1}, {1,0x17d093,1}},
        },
       }
end
